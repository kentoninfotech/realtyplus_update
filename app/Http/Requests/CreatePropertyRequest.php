...
class CreatePropertyRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        // This is done within the rules method as it's needed for dynamic rules
        ...
        if ($this->boolean('has_units')) {
            ...
            $rules['total_units'] = ['nullable', 'integer', 'min:1'];
    ...
    {
        return [
            // Custom messages here if needed, e.g.:
            // 'bedrooms.required' => 'The number of bedrooms is required for this property type.',
        ];
    }
