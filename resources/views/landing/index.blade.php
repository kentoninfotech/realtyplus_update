                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    <p
                                        class="d-inline-block border border-white rounded text-primary fw-semi-bold py-1 px-3 animated slideInDown">
                                        Welcome to THE RealtyPlus LTD</p>
                    ...
                    <div class="service-item rounded overflow-hidden">
                        <div class="position-relative overflow-hidden">
                            @if(isset($property->images) && $property->images->count() > 0)
                                ...
                                @endphp
                                <img class="img-fluid" src="{{ asset($featuredImage->image_path) }}" style="height: 280px; width: 100%;" alt="RealtyPlus Property">
                            @else
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">
                        ...
                        At RealtyPlus Ltd, we understand that quality is paramount in construction. Our team of experienced professionals is committed to delivering superior craftsmanship in every project we undertake. From residential homes to commercial buildings and civil infrastructure, we use only the highest quality materials and adhere to rigorous standards to ensure the longevity and durability of our constructions. Our meticulous attention to detail and dedication to excellence result in structures that not only meet but exceed our clients' expectations.
                        <br><br>

                        <b>Comprehensive and Customized Services</b>
                        <br>
                        We offer a wide range of services tailored to meet the unique needs of our clients. Whether you require architectural design, residential construction, or large-scale civil infrastructure projects, RealtyPlus Ltd provides end-to-end solutions. Our comprehensive services include site analysis, space planning, 3D modeling, interior design, and project management. By working closely with our clients, we ensure that every aspect of the project aligns with their vision, budget, and timeline. This personalized approach sets us apart and ensures that each project is a true reflection of our clients' aspirations.
                        <br><br>

                        <b>Commitment to Sustainability and Innovation</b>
                        <br>
                        In today's world, sustainability is more important than ever. At RealtyPlus Ltd, we are committed to incorporating sustainable practices into all our projects. We utilize eco-friendly materials, energy-efficient designs, and cutting-edge technologies to minimize our environmental impact and promote long-term sustainability. Our innovative approach to construction not only benefits the environment but also provides our clients with energy-efficient and cost-effective solutions. By choosing us, clients are investing in a future where their structures are both beautiful and environmentally responsible.
                        <br><br>
                        People choose RealtyPlus Ltd because we deliver exceptional quality, offer customized and comprehensive services, and are committed to sustainability and innovation. Our reputation for excellence, our dedication to client satisfaction, and our forward-thinking approach make us the preferred choice for construction and architectural services.
                    </p>
                </div>
                <div class="col-lg-6">
    ...
    <div class="container-xxl service py-5" id="services">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1 class="display-5 mb-5">RealtyPlus Ltd Services</h1>
            </div>
                        ...
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-4">At RealtyPlus Ltd, our building construction services are designed to bring our clients' visions to life with precision and excellence. We handle every aspect of the construction process, from initial planning and design to the final finishing touches, ensuring that each project is completed on time, within budget, and to the highest standards. Whether it's a residential home, commercial building, or industrial facility, our experienced team leverages the latest construction technologies and best practices to deliver structures that are durable, functional, and aesthetically pleasing.</p>
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="testimonial-item">
                    <div class="testimonial-text border rounded p-4 pt-5 mb-5">
                        ...
                        “Keep it up RealtyPlus, I got my projects fixed.”
                    </div>
