...
@section('content')
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h4 class="card-title">Edit {{$owner->name }}' Records</h4>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="first_name" id="first_name"
                            placeholder="Enter a First Name" value="{{$owner->first_name }}">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="last_name">Last Name</label>
                        <input type="text" class="form-control" name="last_name" id="last_name"
                            placeholder="Enter a Last Name" value="{{$owner->last_name }}">
                    </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea rows="3" type="text" class="form-control" name="address" id="address"
                            placeholder="Residential or office address">{{ $owner->address ?? '' }}
                        </textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="status" id="status" class="form-control">
                            <option value="{{ $owner->status ?? '' }}" selected>
                                {{ $owner->status ?? 'Select Status' }}</option>
