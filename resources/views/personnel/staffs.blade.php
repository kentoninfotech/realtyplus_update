            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex align-items-center">
                        <img src="{{ (isset($staff->personnel->picture) && $staff->personnel->picture !== null) ? asset('personnel-files/pictures/' .$staff->personnel->picture) : 'https://ui-avatars.com/api/?name=' . urlencode($staff->name) }}" class="rounded-circle me-2" width="40" height="40" alt="{{ $staff->name }}">
