            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex align-items-center">
                        <img src="{{ (isset($worker->personnel->picture) && $worker->personnel->picture !== null) ? asset('personnel-files/pictures/' .$worker->personnel->picture) : 'https://ui-avatars.com/api/?name=' . urlencode($worker->name) }}" class="rounded-circle me-2" width="40" height="40" alt="{{ $worker->name }}">
