            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('leases') }}">Leases</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <div id="property_selection_fields">
                            <div class="form-group">
                                ...
                                <select name="property_id" id="property_id" class="form-control select2" {{ isset($unit) ? 'disabled' : '' }}>
                                    <option value="">Select Property</option>
                                    @foreach($properties as $prop)
                                        <option value="{{ $prop->id }}" {{ (old('property_id', $selectedProperty->id ?? '') == $prop->id) ? 'selected' : '' }}>
                            ...
                            <div class="form-group" id="unit_dropdown_group">
                                ...
                                <select name="property_unit_id" id="property_unit_id" class="form-control select2">
                                    ...
                                    @if(isset($unit) && $unit->id)
                                        {{-- If pre-selected unit, add it to the dropdown --}}
                                        <option value="{{ $unit->id }}" selected>{{ $unit->unit_number }}</option>
                                    @elseif(old('property_unit_id'))
                                        {{-- If old input for unit, try to find it and add it --}}
                                        @php
                                            $oldUnit = \App\Models\Unit::find(old('property_unit_id'));
                                        @endphp
                                        @if($oldUnit)
                                            <option value="{{ $oldUnit->id }}" selected>{{ $oldUnit->unit_number }}</option>
                                        @endif
                                    @endif
                                    {{-- Other units will be loaded via AJAX --}}
                                </select>
