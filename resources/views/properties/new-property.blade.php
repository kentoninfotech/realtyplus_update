            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('propertys') }}">Propertys</a></li>
        ...
        <div class="card-body">
            <form action="{{ route('create.property') }}" method="post">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="owner_id" id="owner_id" class="form-control select2" required>
                            ...
                            @foreach($owners as $owner)
                                <option value="{{ $owner->id }}">{{ $owner->first_name }} {{ $owner->last_name }}{{ $owner->company_name ? ' ('.$owner->company_name.')' : '' }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <select name="agent_id" id="agent_id" class="form-control select2">
                            ...
                            @foreach($agents as $agent)
                                <option value="{{ $agent->id }}">{{ $agent->first_name }} {{ $agent->last_name }}{{ $agent->license_number ? ' ('.$agent->license_number.')' : '' }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control wyswygeditor">
                        {{ old('description') }}Place <em>some</em> <u>text</u> <strong>here</strong>
                    </textarea>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" name="lot_size_sqft" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="datetime-local" name="listed_at" class="form-control">
                    </div>
                </div>
