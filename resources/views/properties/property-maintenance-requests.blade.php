...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body" style="overflow: auto;">
          @can('create property')
            <a href="{{-- route('new.request') --}}" class="btn btn-primary" style="float: right;">Add New</a>
          @endcan
            <br>
            <table class="table responsive-table" id="products">
                ...
                <tbody>
                    @foreach ($maintenanceRequests as $request)
                        <tr @if ($request->status == 'open') style="background-color: azure !important;" @endif>
                            <td>{{ $request->id }}</td>
                            <td>{{ $request->title }}</td>
                              ...
                              <div class="btn-group">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu text-center">
                                        ...
                                        @endcan
                                        @can('edit property')
                                            <a class="dropdown-item" href="{{-- route('edit.request', $request->id) --}}"><i class="fa fa-edit"></i> Edit</a>
                                        @endcan
                                        @can('delete property')
                                            <div class="dropdown-divider"></div>
                                            <form class="d-inline" action="{{-- route('delete.request', $request->id) --}}" method="post">
                                                @csrf
                                                @method('DELETE')
