...
// LEASES
Route::get('leases/create', [App\Http\Controllers\LeaseController::class, 'newLease'])->name('new.lease');
Route::get('leases/', [App\Http\Controllers\LeaseController::class, 'createLease'])->name('create.lease');
